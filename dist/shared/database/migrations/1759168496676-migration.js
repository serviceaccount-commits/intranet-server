...
exports.Migration1759168496676 = void 0;
class Migration1759168496676 {
    name = 'Migration1759168496676';
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."article_versions_article_status_enum" AS ENUM('published', 'draft', 'outdated')`);
    ...
    async down(queryRunner) {
        await queryRunner.query(`CREATE TYPE "public"."article_versions_article_status_enum_old" AS ENUM('published', 'draft', 'archived')`);
        await queryRunner.query(`ALTER TABLE "article_versions" ALTER COLUMN "article_status" DROP DEFAULT`);
...
exports.Migration1759168496676 = Migration1759168496676;
//# sourceMappingURL=1759168496676-migration.js.map