...
exports.Migration1759341968674 = void 0;
class Migration1759341968674 {
    name = 'Migration1759341968674';
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "role_permissions" DROP CONSTRAINT "FK_17022daf3f885f7d35423e9971e"`);
        await queryRunner.query(`ALTER TABLE "permissions" DROP CONSTRAINT "PK_1717db2235a5b169822e7f753b1"`);
        await queryRunner.query(`ALTER TABLE "permissions" DROP COLUMN "permission_id"`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD "permission_id" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD CONSTRAINT "PK_1717db2235a5b169822e7f753b1" PRIMARY KEY ("permission_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD "permission_id" character varying NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "permissions" DROP CONSTRAINT "PK_1717db2235a5b169822e7f753b1"`);
        await queryRunner.query(`ALTER TABLE "permissions" DROP COLUMN "permission_id"`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD "permission_id" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "permissions" ADD CONSTRAINT "PK_1717db2235a5b169822e7f753b1" PRIMARY KEY ("permission_id")`);
        await queryRunner.query(`ALTER TABLE "role_permissions" ADD CONSTRAINT "FK_17022daf3f885f7d35423e9971e" FOREIGN KEY ("permission_id") REFERENCES "permissions"("permission_id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
}
exports.Migration1759341968674 = Migration1759341968674;
//# sourceMappingURL=1759341968674-migration.js.map