...
let AssignmentController = class AssignmentController {
    ...
    async createAssignment(req, res) {
        ...
        const newAssignment = await this.assignmentService.createAssignment(assignmentName);
        res.json(newAssignment);
    }
    async getAssignments(_req, res) {
...
exports.AssignmentController = AssignmentController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(containerTypes_1.TYPES.IAssignmentService)),
