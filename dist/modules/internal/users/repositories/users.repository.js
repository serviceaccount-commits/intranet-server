...
const UserDetails_entity_1 = require("../entities/UserDetails.entity");
...
class UserRepository {
    ...
    async findUserByPersonalEmail(email) {
        return await data_source_1.AppDataSource.manager.findOne(UserDetails_entity_1.UserDetails, {
            where: {
