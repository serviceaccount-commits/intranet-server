...
const USAGE_OPENER =
  /^\s*(use this guide|this guide is (useful|relevant)|relevant for|us[ae] esta gu[ií]a|utili[cz]a esta gu[ií]a|esta gu[ií]a (es útil|sirve|aplica)|consulta esta gu[ií]a)\b[^.!?]*[.!?]\s*/i;
const stripUsageOpener = (text: string): string => {
