...
export class Migration1759168496676 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."article_versions_article_status_enum" AS ENUM('published', 'draft', 'outdated')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."article_versions_article_status_enum_old" AS ENUM('published', 'draft', 'archived')`,
    );
    await queryRunner.query(
      `ALTER TABLE "article_versions" ALTER COLUMN "article_status" DROP DEFAULT`,
    );
